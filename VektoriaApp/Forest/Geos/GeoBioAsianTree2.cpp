#include "GeoBioAsianTree2.h"

namespace Vektoria
{
	CGeoBioAsianTree2::CGeoBioAsianTree2()
	{
	}
	...
	void CGeoBioAsianTree2::Init(CGeoBioAsianTree2 * pzgTemplate, unsigned int uLoD)
	{
		if (!pzgTemplate)
		{
			return;
	...
	void CGeoBioAsianTree2::DeIterate()
	{
